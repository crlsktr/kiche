...
<AppShell>
	<svelte:fragment slot="header">
		...
		<AppBar>
			...
			<svelte:fragment slot="trail">
				<LightSwitch />
				<button class="btn variant-filled-primary" id="install">Install</button>
			</svelte:fragment>
		</AppBar>
	</svelte:fragment>
	...
	<svelte:fragment slot="sidebarLeft">
		<AppRail>
			...
			<AppRailAnchor
				selected={$page.url.pathname === `${base}/ajilabal`}
				name="tile-ajilabal"
				value={1}
				title="tile-ajilabal"
				href="{base}/ajilabal"
			...
			<AppRailAnchor
				selected={$page.url.pathname === `${base}/natajem`}
				name="tile-natajem"
				value={1}
				title="tile-natajem"
				href="{base}/natajem"
	...
	<svelte:fragment slot="pageFooter">
		<div class="text-right">
			Hecho con ❤️ y con Svelte-kit, <a
...
<style lang="postcss">
	svg {
		@apply scale-150 fill-surface-100;
		display: block;
	}
</style>
